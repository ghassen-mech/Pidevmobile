...
public class serviceformation {
    ...
    public ArrayList<formation> getAllTasks(String t){
        String url = Statics.BASE_URL+"/client/affcihefjson/"+t;
        req.setUrl(url);
        req.setPost(false);
     ...
     public ArrayList<formation> getMesformation(){
        String url = Statics.BASE_URL+"/client/affcihemesfjson/"+UserService.idConnect;
        req.setUrl(url);
        req.setPost(false);
     ...
     public ArrayList<User> parseparticipants(String jsonText){
        ...
        */
        return participants;
         ...
         public ArrayList<User> getlistparticipants(int t){
