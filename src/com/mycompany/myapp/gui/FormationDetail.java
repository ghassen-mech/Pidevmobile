    ...
    int nbrpart=0;
     public FormationDetail(Resources res) {
       ...
       tb.setTitleComponent(titleCmp);
        ...
        ArrayList<User> array=serviceformation.getInstance().getlistparticipants(Formationclient.idf);
          ...
          //Participer a une formation
            ...
            public void actionPerformed(ActionEvent evt) {
                    ...
                    try {
                       ...
                       if( serviceformation.getInstance().ParticiperF(Formationclient.idf,UserService.idConnect,Formationclient.sujetf)){
                                                                                      //het l'id ye 3ajngui
