...
public class Formationstatistic extends SideMenuBaseForm{
    ...
    public Formationstatistic(Resources res) {
        ...
        ArrayList<formation> array=serviceformation.getInstance().getAllTasks();
        ...
        ArrayList<utilisateur> array2=serviceformation.getInstance().getlistparticipants(idfor);
